...
for i in range(1,41):
    svFile="hint_M{:02}.txt".format(i)
    makeQR(txt,etype=qrcode.ERROR_CORRECT_M,ver=i).save("./temp3.png")
    im = numpy.array(Image.open("./temp3.png"))
    q = makeProb(im)

    with open(svFile, mode="w", encoding="utf-8", newline="\n") as f:
